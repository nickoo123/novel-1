    ...
    <div id="wrap">
        <div id="main" class="wp">
                    ...
                    <div class="tool-dir-list">
                        <ul>
                            ...
                            <li id="dir_li_{{.Id}}" name="{{.ChapterNo}}">
                                <a href="{{urlfor "home.BookController.Detail" "id" .Id "novid" $.Nov.HashKey}}"
            ...
            <div id="toolbtn">
                ...
                {{if not_nil .Pre}}
                <a href="{{urlfor "home.BookController.Detail" "id" .Pre.Id "novid" .Nov.HashKey}}" class="toolbtn-prev"><i
                        class="fa fa-chevron-up"></i><i class="icon icon-tool-prev"></i><span
                        class="help-text">查看上一页</span></a>
                {{end}}
                {{if not_nil .Next}}
                <a href="{{urlfor "home.BookController.Detail" "id" .Next.Id "novid" .Nov.HashKey}}" class="toolbtn-next"><i
                    ...
                    <div id="bookshelf">
                        ...
                        <div class="bookshelf-book">
                            ...
                            <div class="bookshelf-book-info">
                                ...
                                <a href="{{urlfor "home.BookController.Index" "id" .Nov.HashKey}}"
        ...
        function autoRollDsq(setting_var) {
            ...
            timer = setInterval(function(){
                ...
                if (scrollHeight - windowHeight == scrollTop) {
                    ...
                    var url = ""
                    {{if not_nil .Next}}
                        url = '{{urlfor "home.BookController.Detail" "id" .Next.Id "novid" .Nov.HashKey}}'
                    {{end}}
                    if (url == ""){
                        alert("已经到底啦～没有下一页:)")
                    }else{
