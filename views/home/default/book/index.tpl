	...
	<div id="content">
	   ...
	   <div class="detail-section read-notice-sibling">
	    ...
	    <div class="detail-wrap">
	      ...
	      <div class="detail-info">
			...
			{{else}}
	          <a href="{{urlfor "home.BookController.Detail" "id" .FirstChapId "novid" .Nov.HashKey}}" target="_blank" class="btn-read">开始阅读</a>
			{{end}}
	  ...
	  <div class="detail-section">
	    ...
	    <div class="detail-aside">
		  ...
		  {{range .NovCateRanks}}
	      	<li> 
	      		<a href="{{urlfor "home.BookController.Index" "id" .HashKey}}" title="{{.CateName}}-{{.Name}}" target="_blank" class="book-lst-tab">
	    ...
	    <div class="contents-lst-wrap">
		  ...
		  {{range .Chaps}}
	      	<li class="odd">
	      		<a onclick="dealCurrentPageCookie()" href="{{urlfor "home.BookController.Detail" "id" .Id "novid" $.Nov.HashKey}}" class="contents-tab" target="_blank" title="{{.Title}}">
