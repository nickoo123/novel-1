    ...
    <div class="all-pro-wrap box-center cf">
						...
						{{range .Novs}}
                            <li>
								<div class="book-img-box">
									<a href="{{urlfor "home.BookController.Index" "id" .HashKey}}" target="_blank" class="f-pic-box">
										<img src="{{$.mOut.ViewUrl}}img/nocover.jpg" {{if ne .Cover ""}}data-echo="{{.Cover}}"{{end}}>
									</a>
								</div>
								<div class="book-mid-info">
									<h4><a href="{{urlfor "home.BookController.Index" "id" .HashKey}}" target="_blank">{{str2html .Name}}</a></h4>
									<p class="author">
		...
		<div class="detail-aside">
		  ...
		  {{range .NovRanks}}
			<li> 
				<a href="{{urlfor "home.BookController.Index" "id" .HashKey}}" target="_blank" class="book-lst-tab">
